...
const allMockableServices: readonly string[] = ["auth", "brawlback", "dolphin"];
...
const generateMockModuleReplacementPlugin = (servicesToMock: readonly string[]): webpack.WebpackPluginInstance[] => {
  ...
  // We also join the services using | in order to match the possible groups. e.g. (auth|brawlback).
