// taken directly from https://github.com/project-slippi/slippi-js/blob/master/src/console/dolphinConnection.ts

import type { Connection, ConnectionDetails, ConnectionSettings } from "@common/brawlback-js/types";
